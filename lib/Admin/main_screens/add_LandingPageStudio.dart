...
class LandingPageStudioAdd extends StatefulWidget {
  const LandingPageStudioAdd(
  ...
  @override
  State<LandingPageStudioAdd> createState() => _LandingPageStudioAddState();
}

class _LandingPageStudioAddState extends State<LandingPageStudioAdd> {
  ...
  void deleteItem({
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('landingStudio').doc(docId);
