...
class LandingPageStudioRead extends StatefulWidget {
  const LandingPageStudioRead({Key? key}) : super(key: key);

  @override
  State<LandingPageStudioRead> createState() => _LandingPageStudioReadState();
}

class _LandingPageStudioReadState extends State<LandingPageStudioRead> {
  void initState() {
    super.initState();
