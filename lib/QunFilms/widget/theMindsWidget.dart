...
class mindBehindsWidget extends StatefulWidget {
  const mindBehindsWidget({Key? key}) : super(key: key);

  @override
  State<mindBehindsWidget> createState() => _mindBehindsWidgetState();
}

class _mindBehindsWidgetState extends State<mindBehindsWidget> {
